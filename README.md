...
This operator is managing Kafka in Kubernetes. Operators observe custom resources in a Kubernetes cluster, and manage the application it's responsible for according to the desired state specified in those custom resources.
