...
:crd: {crd-docs}/kafka.stackable.tech/kafkacluster/v1alpha1/
...
* The {crd-docs}/kafka.stackable.tech/kafkacluster/v1alpha1/[KafkaCluster {external-link-icon}^] CRD documentation
