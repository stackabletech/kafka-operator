use stackable_kafka_crd::{
    ...
    STACKABLE_LISTENER_DIR, STACKABLE_TLS_CLIENT_AUTH_DIR, STACKABLE_TLS_CLIENT_DIR,
    STACKABLE_TLS_INTERNAL_DIR, SYSTEM_TRUST_STORE_DIR,
};
...
pub fn prepare_container_cmd_args(kafka: &KafkaCluster) -> String {
    ...
    args.extend(chown_and_chmod(STACKABLE_LISTENER_DIR));
